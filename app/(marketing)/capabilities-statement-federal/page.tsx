...
export const metadata: Metadata = buildMarketingMetadata(getStaticPageSeo("/capabilities-statement-federal")!);

export default function CapabilitiesStatementFederalPage() {
  const { capabilitiesStatementFederalPage } = loadMarketingContent();

  return (
    <main id="main-content" className="marketing-main marketing-main--cap-stmt-services">
      <CapabilitiesStatementPageContent variant="federal" content={capabilitiesStatementFederalPage} />
    </main>
  );
}
