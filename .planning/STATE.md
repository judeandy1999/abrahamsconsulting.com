...
*(Carried from prior milestones — no new execution metrics for Phase 9 yet)*
...
- Upload `ordering-guide.pdf` to `public/documents/nasa-sewp-vi/` when ready (activates Download PDF automatically)
